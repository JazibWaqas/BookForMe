...
\begin{description}
  \item[Neuro-Symbolic AI Architecture]
        The LLM interprets natural language (creative / linguistic), but all database mutations are executed by deterministic LangGraph code nodes
...
\begin{figure}[H]
  ...
  \IfFileExists{images/ERD.png}{
    \includegraphics[width=0.55\textwidth]{images/ERD.png}
  }{
...
\begin{figure}[H]
  ...
  \IfFileExists{images/Class diagram.png}{
    \includegraphics[width=0.55\textwidth]{images/Class diagram.png}
  }{
    \fbox{\parbox{0.85\textwidth}{\centering\vspace{0.8cm}
...
\begin{figure}[H]
  ...
  \IfFileExists{images/AD- App flow booking process.png}{
    \includegraphics[width=0.85\textwidth]{images/AD- App flow booking process.png}
  }{
    \fbox{\parbox{0.85\textwidth}{\centering\vspace{0.8cm}
