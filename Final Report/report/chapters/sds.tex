...
\begin{figure}[H]
    ...
    \IfFileExists{images/FYP - Seq Dig.png}{
        \includegraphics[width=0.9\textwidth]{images/FYP - Seq Dig.png}
...
\begin{figure}[H]
    ...
    \IfFileExists{images/Activity Diagram- Whatsapp Booking flow.png}{
        \includegraphics[width=1.0\textwidth]{images/Activity Diagram- Whatsapp Booking flow.png}
...
\begin{figure}[H]
    ...
    \IfFileExists{images/AD- App flow booking process.png}{
        \includegraphics[width=1.0\textwidth]{images/AD- App flow booking process.png}
...
\begin{figure}[H]
    ...
    \IfFileExists{images/FYP - Vend Activity Dig.png}{
        \includegraphics[width=0.85\textwidth]{images/FYP - Vend Activity Dig.png}
