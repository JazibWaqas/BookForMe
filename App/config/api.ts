...
export const API_ENDPOINTS = {
  ...
  vendors: {
    ...
    booking: (vendorId: string, bookingId: string) => `/api/vendors/${vendorId}/bookings/${bookingId}`,
    ...
    notifications: (id: string) => `/api/vendors/${id}/notifications`,
  ...
  social: {
    ...
    deletePost: (postId: string) => `/api/social/posts/${postId}`,
    comments: (postId: string) => `/api/social/posts/${postId}/comments`,
    createComment: (postId: string) => `/api/social/posts/${postId}/comments`,
    deleteComment: (postId: string, commentId: string) => `/api/social/posts/${postId}/comments/${commentId}`,
